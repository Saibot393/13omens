...
- **Perk:** Includes a description that will be displayed in the PC actor sheet. [Active effects](https://github.com/Saibot393/13omens/wiki/Active-effects) that will take place if the perk is picked by a player can also be added.
